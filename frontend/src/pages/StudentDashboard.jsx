...
const menuItems = [
  ...
  { text: "My Courses", icon: <Book />, path: "/studentDashboard/my-courses" },
  {
    text: "All Programs",
    icon: <School />,
    path: "/studentDashboard/all-programs",
  },
  {
    text: "Quiz Progress",
    icon: <Quiz />,
    path: "/studentDashboard/quiz-progress",
  },
  {
    text: "Grade Results",
    icon: <Grade />,
    path: "/studentDashboard/grade-results",
  },
  {
    text: "Assignment Results",
    icon: <Assignment />,
    path: "/studentDashboard/assignment-results",
  },
  {
    text: "Add/Drop Courses",
    icon: <AddCircleOutline />,
    path: "/studentDashboard/add-drop-courses",
  },
  {
    text: "Accounting",
    icon: <AccountBalance />,
    path: "/studentDashboard/accounting",
  },
  {
    text: "Notifications",
    icon: <Notifications />,
